...
const sheetVariants = cva(
  'fixed z-50 gap-4 p-6 shadow-lg transition ease-in-out bg-app-red-500 ',
  {
    variants: {
      side: {
        ...
        left: 'inset-y-0 left-0 h-full w-1/2 border-r data-[state=closed]:animate-slide-out-to-left data-[state=open]:animate-slide-in-from-left max-w-xs',
        right:
